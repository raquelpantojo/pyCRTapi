...
opcao = st.radio("Selecione uma opção:", ("Fazer um vídeo", "Enviar Vídeo Existente"))

if opcao == "Fazer um vídeo":
    camera_index = st.selectbox("Select Camera", (0, 1, 2, 3))  # Selecione a câmera desejada
